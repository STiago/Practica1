...
<body>
  ...
  <h3>
    <p>
    Aplicación en php que se ocupa de la conversión de una cantidad de peseta a introducir por el usuario, a euros o dólares según su elección.
    </p> 
<h3>
<?php
...
?>
  ...
  <h2>
	...
	<form method=post action=http://practica1-stiago.rhcloud.com>
	Introduzca la cantidad de pesetas: <input type=text name=cantidad size=10>
